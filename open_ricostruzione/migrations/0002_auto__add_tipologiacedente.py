...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TipologiaCedente'
        db.create_table('open_ricostruzione_tipologiacedente', (
        ...
        db.send_create_signal('open_ricostruzione', ['TipologiaCedente'])


    def backwards(self, orm):
        # Deleting model 'TipologiaCedente'
        db.delete_table('open_ricostruzione_tipologiacedente')
