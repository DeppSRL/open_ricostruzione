...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TipologiaProgetto.codice'
        db.alter_column('open_ricostruzione_tipologiaprogetto', 'codice', self.gf('django.db.models.fields.SmallIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'TipologiaProgetto.codice'
        db.alter_column('open_ricostruzione_tipologiaprogetto', 'codice', self.gf('django.db.models.fields.SmallIntegerField')(default=0))
