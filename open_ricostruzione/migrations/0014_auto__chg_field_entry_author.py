...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('open_ricostruzione_entry', 'author', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Entry.author'
        db.alter_column('open_ricostruzione_entry', 'author', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
    ...
    models = {
        ...
        'open_ricostruzione.entry': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'published_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 12, 0, 0)'}),
