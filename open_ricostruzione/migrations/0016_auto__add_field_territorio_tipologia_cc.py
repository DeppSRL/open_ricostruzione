...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Territorio.tipologia_cc'
        db.add_column('open_ricostruzione_territorio', 'tipologia_cc',
                      self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Territorio.tipologia_cc'
        db.delete_column('open_ricostruzione_territorio', 'tipologia_cc')
