...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Entry'
        db.create_table('open_ricostruzione_entry', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('abstract', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('author', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('body', self.gf('django.db.models.fields.TextField')()),
            ('published_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 12, 10, 0, 0))),
        ))
        db.send_create_signal('open_ricostruzione', ['Entry'])


    def backwards(self, orm):
        # Deleting model 'Entry'
        db.delete_table('open_ricostruzione_entry')
    ...
    models = {
        ...
        'open_ricostruzione.entry': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'published_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 10, 0, 0)'}),
