...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Donazione.modalita_r'
        db.add_column('open_ricostruzione_donazione', 'modalita_r',
                      self.gf('django.db.models.fields.TextField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Donazione.modalita_r'
        db.delete_column('open_ricostruzione_donazione', 'modalita_r')
