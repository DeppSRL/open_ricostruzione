...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('open_ricostruzione_entry', 'abstract', self.gf('django.db.models.fields.CharField')(max_length=400))

    def backwards(self, orm):

        # Changing field 'Entry.abstract'
        db.alter_column('open_ricostruzione_entry', 'abstract', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        'open_ricostruzione.entry': {
            ...
            'abstract': ('django.db.models.fields.CharField', [], {'max_length': '400'}),
