...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Territorio.gps_lat'
        db.add_column('open_ricostruzione_territorio', 'gps_lat',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Territorio.gps_lon'
        db.add_column('open_ricostruzione_territorio', 'gps_lon',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Territorio.gps_lat'
        db.delete_column('open_ricostruzione_territorio', 'gps_lat')

        # Deleting field 'Territorio.gps_lon'
        db.delete_column('open_ricostruzione_territorio', 'gps_lon')
    ...
    models = {
        ...
        'open_ricostruzione.entry': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'published_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 20, 0, 0)'}),
