...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Donazione.info'
        db.alter_column('open_ricostruzione_donazione', 'info', self.gf('django.db.models.fields.TextField')(max_length=1000, null=True))

        # Changing field 'Donazione.progetto'
        db.alter_column('open_ricostruzione_donazione', 'progetto_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['open_ricostruzione.Progetto'], null=True))

    def backwards(self, orm):

        # Changing field 'Donazione.info'
        db.alter_column('open_ricostruzione_donazione', 'info', self.gf('django.db.models.fields.TextField')(default='', max_length=1000))

        # Changing field 'Donazione.progetto'
        db.alter_column('open_ricostruzione_donazione', 'progetto_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['open_ricostruzione.Progetto']))
