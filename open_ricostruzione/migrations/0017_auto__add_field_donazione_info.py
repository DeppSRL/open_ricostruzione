...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Donazione.info'
        db.add_column('open_ricostruzione_donazione', 'info',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=1000),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Donazione.info'
        db.delete_column('open_ricostruzione_donazione', 'info')
    ...
    models = {
        'open_ricostruzione.donazione': {
            ...
            'info': ('django.db.models.fields.TextField', [], {'max_length': '1000'}),
