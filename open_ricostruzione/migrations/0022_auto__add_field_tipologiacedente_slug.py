...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TipologiaCedente.slug'
        db.add_column('open_ricostruzione_tipologiacedente', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=60),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TipologiaCedente.slug'
        db.delete_column('open_ricostruzione_tipologiacedente', 'slug')
