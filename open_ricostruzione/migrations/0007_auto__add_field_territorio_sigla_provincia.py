...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Territorio.sigla_provincia'
        db.add_column('open_ricostruzione_territorio', 'sigla_provincia',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Territorio.sigla_provincia'
        db.delete_column('open_ricostruzione_territorio', 'sigla_provincia')
