...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TipologiaProgetto.slug'
        db.add_column('open_ricostruzione_tipologiaprogetto', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TipologiaProgetto.slug'
        db.delete_column('open_ricostruzione_tipologiaprogetto', 'slug')
