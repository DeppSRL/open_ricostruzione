...
class InterventoProgramma(models.Model):
    TIPO_IMMOBILE_FENICE = Choices(
        ...
        (u'31', u'ATTR_SANITARIE', u'ATTREZZATURE SOCIO SANITARIE'),
        (u'32', u'CHIESA', u'CHIESE E EDIFICI DI CULTO'),
        (u'33', u'BENI_ECCLESIASTICI', u'EDIFICI ECCLESIASTICI'),
        (u'34', u'EDIFICI_PUBBLLICI', u'EDIFICI PUBBLICI'),
        (u'35', u"EDILIZIA_SCOLASTICA", u"EDILIZIA SCOLASTICA E UNIVERSITA'"),
        (u'36', u'INFRASTR_MOBIL', u"INFRASTRUTTURE E MOBILITA'"),
    )
