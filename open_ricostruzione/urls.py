...
urlpatterns = patterns('',
    ...
    url(r'^progetti/(?P<tipologia>[-\w]+)/(?P<comune>[-\w]+)(\?page=(?P<page>[-\d]+))?$', ProgettiTipologiaComune.as_view(), name="progetti-tipologia-comune"),
    #url(r'^progetti-tipologia/(?P<tipologia>[-\w]+)(\?page=(?P<page>[-\d]+))?$', ProgettiTipologia.as_view(), name="progetti-tipologia"),
    url(r'^progetti-tipologia/(?P<tipologia>[-\w]+)$', ProgettiTipologia.as_view(), name="progetti-tipologia"),
    url(r'^progetti-comune/(?P<comune>[-\w]+)(\?page=(?P<page>[-\d]+))?$', ProgettiComune.as_view(), name="progetti-comune"),
